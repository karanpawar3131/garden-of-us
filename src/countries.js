// ISO 3166-1 alpha-2 codes + dial codes for the country-code picker.
// Sorted alphabetically by display name. India is the default selection.
...
// Convert an ISO-2 country code to its regional-indicator flag emoji.
// "IN" -> 🇮🇳, "US" -> 🇺🇸. Falls back to empty string on bad input.
export const flagEmoji = (iso2) => {
  if (!iso2 || iso2.length !== 2) return '';
  const A = 'A'.charCodeAt(0);
  return String.fromCodePoint(
    0x1F1E6 + iso2.toUpperCase().charCodeAt(0) - A,
    0x1F1E6 + iso2.toUpperCase().charCodeAt(1) - A,
  );
};
